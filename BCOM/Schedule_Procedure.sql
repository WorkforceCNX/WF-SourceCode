...
*/
    INSERT INTO BCOM.Schedule (  -- Insert data to BCOM.Schedule 
		...
		[Booking Email], [CUIC Name], [PST_Start_Date], [Date], [Tenure], [Tenure days], [Week_num], [Shift_definition], [YEAR], [MONTH], [Week_day], [Termination/Transfer], [LOB Group], [ScheduleSeconds(s)], [Work Type]
    )
