...
ROSTER_RAW3.[TL_ID], ROSTER_RAW3.[TL_Name], ROSTER_RAW3.[Emp ID], ROSTER_RAW3.[Emp_Name], ROSTER_RAW3.[Wave], ROSTER_RAW3.[Booking Login ID], ROSTER_RAW3.[TED Name], ROSTER_RAW3.[cnx_email], ROSTER_RAW3.[Booking Email], 
...
/*014 - ROSTER_RAW3*/ EEAAO_RAW.[Wave],
/*015 - ROSTER_RAW3*/ EEAAO_RAW.[Booking Login ID],
/*016 - ROSTER_RAW3*/ EEAAO_RAW.[TED Name],
/*017 - ROSTER_RAW3*/ EEAAO_RAW.[cnx_email],
/*018 - ROSTER_RAW3*/ EEAAO_RAW.[Booking Email],
/*019 - ROSTER_RAW3*/ EEAAO_RAW.[CUIC Name],
/*020 - ROSTER_RAW3*/ EEAAO_RAW.[PST_Start_Date],
/*021 - ROSTER_RAW3*/ EEAAO_RAW.[Termination/Transfer],
/*022 - Staff_RAW*/ EEAAO_RAW.[Tenure],
/*023 - Staff_RAW*/ EEAAO_RAW.[Tenure days],
/*024 - ROSTER_RAW3*/ EEAAO_RAW.[LOB],
/*025 - ROSTER_RAW3*/ EEAAO_RAW.[LOB Group],
/*026 - PremHday_RAW*/ EEAAO_RAW.[Holiday],
/*027 - RAMCO_RAW*/ EEAAO_RAW.[Ramco_Code],
/*028 - ROSTER_RAW3*/ EEAAO_RAW.[Shift],
/*029 - ROSTER_RAW3*/ EEAAO_RAW.[Original_Shift],
/*030 - ROSTER_RAW3*/ EEAAO_RAW.[week_shift],
/*031 - ROSTER_RAW3*/ EEAAO_RAW.[week_off],
/*032 - ROSTER_RAW3*/ EEAAO_RAW.[Shift_definition],
/*033 - ROSTER_RAW3*/ EEAAO_RAW.[Shift_type],
/*034 - ROSTER_RAW3+RAMCO_RAW*/ EEAAO_RAW.[ATD_Mismatch],
/*035 - ROSTER_RAW3*/ EEAAO_RAW.[Gap_Shift],
/*036 - ROSTER_RAW3+RAMCO_RAW*/ EEAAO_RAW.[PO_Count(MTD)],
/*037 - ROSTER_RAW3+RAMCO_RAW*/ SUM(Case when (Case when EEAAO_RAW.[Ramco_Code] = 'PO' then 1 Else 0 End) = 1 Then EEAAO_RAW.[Approve OT(s)] Else 0 End) OVER (partition by EEAAO_RAW.[YEAR],EEAAO_RAW.[MONTH],EEAAO_RAW.[Emp ID] order by EEAAO_RAW.[Date]) AS [PO_Dur(MTD)],
/*038 - ROSTER_RAW3+RAMCO_RAW*/ Sum(Case when EEAAO_RAW.[Ramco_Code] <> 'PO' then EEAAO_RAW.[Approve OT(s)] Else 0 End) OVER (partition by EEAAO_RAW.[YEAR],EEAAO_RAW.[MONTH],EEAAO_RAW.[Emp ID] order by EEAAO_RAW.[Date]) AS [OT_Dur(MTD)],
/*039 - ROSTER_RAW3+RAMCO_RAW*/ Case when EEAAO_RAW.[Approve OT(s)] < EEAAO_RAW.[OT_Registered(s)] then 1 Else 0 End AS [OvertimeSufficient],
/*040 - ROSTER_RAW3+RAMCO_RAW*/ Case when EEAAO_RAW.[Ramco_Code] = 'PR' and EEAAO_RAW.[Approve OT(s)] > 14400 Then 1 when EEAAO_RAW.[Ramco_Code] = 'PO' and EEAAO_RAW.[Approve OT(s)] > 28800 Then 1 Else 0 End AS [OvertimeOverLimit],
/*041 - RAMCO_RAW*/ EEAAO_RAW.[PR_Count(MTD)],
/*042 - RAMCO_RAW*/ EEAAO_RAW.[OverConsecutive],
/*043 - EPS_RAW4*/ EEAAO_RAW.[Login],
/*044 - EPS_RAW4*/ EEAAO_RAW.[Logout],
/*045*/ EEAAO_RAW.[Logout_Count],
/*046 - EPS_RAW4*/ EEAAO_RAW.[Late-Soon],
/*047 - EPS_RAW4+RAMCO_RAW*/ EEAAO_RAW.[PR<8.75],
/*048 - EPS_RAW4+ROSTER_RAW3*/ EEAAO_RAW.[LoggedInOnOffDay],
/*049 - RegisteredOT_RAW*/ EEAAO_RAW.[OT_Registered(s)],
/*050 - RegisteredOT_RAW*/ EEAAO_RAW.[OT_Registered_Type],
/*051 - EPS_RAW+RegisteredOT_RAW*/ EEAAO_RAW.[Approve OT(s)],
/*052 - OTRAMCO_RAW*/ EEAAO_RAW.[OT_Ramco(s)],
/*053 - OTRAMCO_RAW*/ EEAAO_RAW.[PH_Ramco(s)],
/*054 - OTRAMCO_RAW*/ EEAAO_RAW.[NSA_Ramco(s)],
/*055 - EPS_RAW4*/ EEAAO_RAW.[NotLoggedOutAfterShift],
/*056 - EPS_RAW4*/ EEAAO_RAW.[LoggedInBeforeShift],
/*057 - EPS_RAW4*/ EEAAO_RAW.[LowPerf],
/*058 - ExceptionReq_RAW*/ EEAAO_RAW.[ExceptionReq(s)],
/*059 - CPI_RAW3*/ EEAAO_RAW.[Total_Cases],
/*060 - CPI_RAW3*/ EEAAO_RAW.[Total_#TED],
/*061 - CPI_RAW3*/ EEAAO_RAW.[#TED_phone],
/*062 - CPI_RAW3*/ EEAAO_RAW.[#TED_outbound_phone_call],
/*063 - CPI_RAW3*/ EEAAO_RAW.[#TED_email],
/*064 - CPI_RAW3*/ EEAAO_RAW.[#TED_Undefined],
/*065 - CPI_RAW3*/ EEAAO_RAW.[#TED_messaging],
/*066 - CPI_RAW3*/ EEAAO_RAW.[#TED_chat],
/*067 - CPI_RAW3*/ EEAAO_RAW.[#TED_research],
/*068 - CPI_RAW3*/ EEAAO_RAW.[Phone_#TED],
/*069 - CPI_RAW3*/ EEAAO_RAW.[NonPhone_#TED],
/*070 - CPI_RAW3*/ EEAAO_RAW.[Total_#PEGA],
/*071 - CPI_RAW3*/ EEAAO_RAW.[#PEGA_email],
/*072 - CPI_RAW3*/ EEAAO_RAW.[#PEGA_Undefined],
/*073 - CPI_RAW3*/ EEAAO_RAW.[#PEGA_messaging],
/*074 - CPI_RAW3*/ EEAAO_RAW.[#PEGA_phone],
/*075 - CPI_RAW3*/ EEAAO_RAW.[#PEGA_chat],
/*076 - CPI_RAW3*/ EEAAO_RAW.[#PEGA_outbound_phone_call],
/*077 - CPI_RAW3*/ EEAAO_RAW.[#PEGA_research],
/*078 - CPI_RAW3*/ EEAAO_RAW.[Phone_#PEGA],
/*079 - CPI_RAW3*/ EEAAO_RAW.[NonPhone_#PEGA],
/*080 - CPI_RAW3*/ EEAAO_RAW.[Total_#Swiveled],
/*081 - CPI_RAW3*/ EEAAO_RAW.[#Swiveled_email],
/*082 - CPI_RAW3*/ EEAAO_RAW.[#Swiveled_Undefined],
/*083 - CPI_RAW3*/ EEAAO_RAW.[#Swiveled_messaging],
/*084 - CPI_RAW3*/ EEAAO_RAW.[#Swiveled_phone],
/*085 - CPI_RAW3*/ EEAAO_RAW.[#Swiveled_chat],
/*086 - CPI_RAW3*/ EEAAO_RAW.[#Swiveled_outbound_phone_call],
/*087 - CPI_RAW3*/ EEAAO_RAW.[#Swiveled_research],
/*088 - CPI_RAW3*/ EEAAO_RAW.[Phone_#Swiveled],
/*089 - CPI_RAW3*/ EEAAO_RAW.[NonPhone_#Swiveled],
/*090 - RONA_RAW*/ EEAAO_RAW.[#RONA],
/*091 - CUIC_RAW*/ EEAAO_RAW.[AgentAvailTime(s)],
/*092 - CUIC_RAW*/ EEAAO_RAW.[CUICLoggedTime(s)],
/*093 - EPS_RAW4*/ EEAAO_RAW.[Productive(s)],
/*094 - EPS_RAW4*/ EEAAO_RAW.[Night_Productive(s)],
/*095 - EPS_RAW4*/ EEAAO_RAW.[Day_Productive(s)],
/*096 - EPS_RAW4*/ EEAAO_RAW.[Downtime(s)],
/*097 - EPS_RAW4*/ EEAAO_RAW.[Night_Downtime(s)],
/*098 - EPS_RAW4*/ EEAAO_RAW.[Day_Downtime(s)],
/*099 - EPS_RAW4*/ EEAAO_RAW.[Delivery(s)],
/*100 - EPS_RAW4*/ EEAAO_RAW.[Night_Delivery(s)],
/*101 - EPS_RAW4*/ EEAAO_RAW.[Day_Delivery(s)],
/*102 - AHT_RAW*/ EEAAO_RAW.[Handling_Time(s)],
/*103 - AHT_RAW*/ EEAAO_RAW.[Total_IB(s)],
/*104 - AHT_RAW*/ EEAAO_RAW.[Overall_AHT_Time],
/*105 - AHT_RAW*/ EEAAO_RAW.[Overall_AHT_Count],
/*106 - AHT_RAW*/ EEAAO_RAW.[AHT_Phone_time(s)],
/*107 - AHT_RAW*/ EEAAO_RAW.[AHT_Phone_Count],
/*108 - AHT_RAW*/ EEAAO_RAW.[AHT_NonPhone_time(s)],
/*109 - AHT_RAW*/ EEAAO_RAW.[AHT_NonPhone_Count],
/*110 - AHT_RAW*/ EEAAO_RAW.[Talk_Time(s)],
/*111 - AHT_RAW*/ EEAAO_RAW.[Talk_Count],
/*112 - AHT_RAW*/ EEAAO_RAW.[Wrap_Time(s)],
/*113 - AHT_RAW*/ EEAAO_RAW.[Wrap_Count],
/*114 - AHT_RAW*/ EEAAO_RAW.[Hold_Time(s)],
/*115 - AHT_RAW*/ EEAAO_RAW.[Hold_Count],
/*116 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Phone_CSAT_TP],
/*117 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Phone_Survey_TP],
/*118 - CSAT_CMB_RAW2*/ EEAAO_RAW.[NonPhone_CSAT_TP],
/*119 - CSAT_CMB_RAW2*/ EEAAO_RAW.[NonPhone_Survey_TP],
/*120 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Phone_CSAT_RS],
/*121 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Phone_Survey_RS],
/*122 - CSAT_CMB_RAW2*/ EEAAO_RAW.[NonPhone_CSAT_RS],
/*123 - CSAT_CMB_RAW2*/ EEAAO_RAW.[NonPhone_Survey_RS],
/*124 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Phone_CSAT],
/*125 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Phone_Survey],
/*126 - CSAT_CMB_RAW2*/ EEAAO_RAW.[NonPhone_CSAT],
/*127 - CSAT_CMB_RAW2*/ EEAAO_RAW.[NonPhone_Survey],
/*128 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Score],
/*129 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Survey],
/*130 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Score(UB)],
/*131 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Survey(UB)],
/*132 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Score(EN)],
/*133 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Survey(EN)],
/*134 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Score(XU)],
/*135 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Survey(XU)],
/*136 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Score(VI-CSG)],
/*137 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Survey(VI-CSG)],
/*138 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Score(VI-CSG Overall)],
/*139 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Csat Survey(VI-CSG Overall)],
/*140 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Psat_survey],
/*141 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Psat_Score],
/*142 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Psat_survey(VN)],
/*143 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Psat_Score(VN)],
/*144 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Psat_survey(Ame)],
/*145 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Psat_Score(Ame)],
/*146 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Psat_survey(Bri)],
/*147 - CSAT_CMB_RAW2*/ EEAAO_RAW.[Psat_Score(Bri)],
/*148 - Quality_RAW*/ EEAAO_RAW.[customer_score],
/*149 - Quality_RAW*/ EEAAO_RAW.[customer_weight],
/*150 - Quality_RAW*/ EEAAO_RAW.[business_score],
/*151 - Quality_RAW*/ EEAAO_RAW.[business_weight],
/*152 - Quality_RAW*/ EEAAO_RAW.[compliance_score],
/*153 - Quality_RAW*/ EEAAO_RAW.[compliance_weight],
/*154 - WpSummary_RAW*/ EEAAO_RAW.[Total Ploted(s)],
/*155 - WpSummary_RAW*/ EEAAO_RAW.[Plotted Productive(s)],
/*156 - WpSummary_RAW*/ EEAAO_RAW.[Plotted Downtime(s)],
/*157 - WpSummary_RAW*/ EEAAO_RAW.[Plotted Phone(s)],
/*158 - WpSummary_RAW*/ EEAAO_RAW.[Plotted Picklist(s)],
/*159 - WpSummary_RAW*/ EEAAO_RAW.[Break_Offline Ploted(s)],
/*160 - WpSummary_RAW*/ EEAAO_RAW.[Lunch Ploted(s)],
/*161 - WpSummary_RAW*/ EEAAO_RAW.[Coaching Ploted(s)],
/*162 - WpSummary_RAW*/ EEAAO_RAW.[Team_Meeting Ploted(s)],
/*163 - WpSummary_RAW*/ EEAAO_RAW.[Break Ploted(s)],
/*164 - WpSummary_RAW*/ EEAAO_RAW.[Training Ploted(s)],
/*165 - WpSummary_RAW*/ EEAAO_RAW.[Training_Offline Ploted(s)],
/*166 - WpSummary_RAW*/ EEAAO_RAW.[Termination Ploted(s)],
/*167 - ROSTER_RAW3*/ EEAAO_RAW.[Attendance(s)],
/*168 - ROSTER_RAW3*/ ISNULL(EEAAO_RAW.[ScheduleSeconds(s)],0) + ISNULL(EEAAO_RAW.[OT_Registered(s)],0) AS [ScheduleSeconds(s)],
/*169 - EPS_RAW4*/ EEAAO_RAW.[StaffTime(s)],
/*170 - EPS_RAW4*/ EEAAO_RAW.[Night_StaffTime(s)],
/*171 - EPS_RAW4*/ EEAAO_RAW.[Day_StaffTime(s)],
/*172 - EPS_RAW4*/ EEAAO_RAW.[Break(s)],
/*173 - EPS_RAW4*/ EEAAO_RAW.[Night_Break(s)],
/*174 - EPS_RAW4*/ EEAAO_RAW.[Day_Break(s)],
/*175 - EPS_RAW4*/ EEAAO_RAW.[Global_Support(s)],
/*176 - EPS_RAW4*/ EEAAO_RAW.[Night_Global_Support(s)],
/*177 - EPS_RAW4*/ EEAAO_RAW.[Day_Global_Support(s)],
/*178 - EPS_RAW4*/ EEAAO_RAW.[Loaner(s)],
/*179 - EPS_RAW4*/ EEAAO_RAW.[Night_Loaner(s)],
/*180 - EPS_RAW4*/ EEAAO_RAW.[Day_Loaner(s)],
/*181 - EPS_RAW4*/ EEAAO_RAW.[Lunch(s)],
/*182 - EPS_RAW4*/ EEAAO_RAW.[Night_Lunch(s)],
/*183 - EPS_RAW4*/ EEAAO_RAW.[Day_Lunch(s)],
/*184 - EPS_RAW4*/ EEAAO_RAW.[Mass_Issue(s)],
/*185 - EPS_RAW4*/ EEAAO_RAW.[Night_Mass_Issue(s)],
/*186 - EPS_RAW4*/ EEAAO_RAW.[Day_Mass_Issue(s)],
/*187 - EPS_RAW4*/ EEAAO_RAW.[Meeting(s)],
/*188 - EPS_RAW4*/ EEAAO_RAW.[Night_Meeting(s)],
/*189 - EPS_RAW4*/ EEAAO_RAW.[Day_Meeting(s)],
/*190 - EPS_RAW4*/ EEAAO_RAW.[Moderation(s)],
/*191 - EPS_RAW4*/ EEAAO_RAW.[Night_Moderation(s)],
/*192 - EPS_RAW4*/ EEAAO_RAW.[Day_Moderation(s)],
/*193 - EPS_RAW4*/ EEAAO_RAW.[New_Hire_Training(s)],
/*194 - EPS_RAW4*/ EEAAO_RAW.[Night_New_Hire_Training(s)],
/*195 - EPS_RAW4*/ EEAAO_RAW.[Day_New_Hire_Training(s)],
/*196 - EPS_RAW4*/ EEAAO_RAW.[Not_Working_Yet(s)],
/*197 - EPS_RAW4*/ EEAAO_RAW.[Night_Not_Working_Yet(s)],
/*198 - EPS_RAW4*/ EEAAO_RAW.[Day_Not_Working_Yet(s)],
/*199 - EPS_RAW4*/ EEAAO_RAW.[Payment_Processing(s)],
/*200 - EPS_RAW4*/ EEAAO_RAW.[Night_Payment_Processing(s)],
/*201 - EPS_RAW4*/ EEAAO_RAW.[Day_Payment_Processing(s)],
/*202 - EPS_RAW4*/ EEAAO_RAW.[Personal_Time(s)],
/*203 - EPS_RAW4*/ EEAAO_RAW.[Night_Personal_Time(s)],
/*204 - EPS_RAW4*/ EEAAO_RAW.[Day_Personal_Time(s)],
/*205 - EPS_RAW4*/ EEAAO_RAW.[Picklist_off_Phone(s)],
/*206 - EPS_RAW4*/ EEAAO_RAW.[Night_Picklist_off_Phone(s)],
/*207 - EPS_RAW4*/ EEAAO_RAW.[Day_Picklist_off_Phone(s)],
/*208 - EPS_RAW4*/ EEAAO_RAW.[Project(s)],
/*209 - EPS_RAW4*/ EEAAO_RAW.[Night_Project(s)],
/*210 - EPS_RAW4*/ EEAAO_RAW.[Day_Project(s)],
/*211 - EPS_RAW4*/ EEAAO_RAW.[RONA(s)],
/*212 - EPS_RAW4*/ EEAAO_RAW.[Night_RONA(s)],
/*213 - EPS_RAW4*/ EEAAO_RAW.[Day_RONA(s)],
/*214 - EPS_RAW4*/ EEAAO_RAW.[Ready_Talking(s)],
/*215 - EPS_RAW4*/ EEAAO_RAW.[Night_Ready_Talking(s)],
/*216 - EPS_RAW4*/ EEAAO_RAW.[Day_Ready_Talking(s)],
/*217 - EPS_RAW4*/ EEAAO_RAW.[Special_Task(s)],
/*218 - EPS_RAW4*/ EEAAO_RAW.[Night_Special_Task(s)],
/*219 - EPS_RAW4*/ EEAAO_RAW.[Day_Special_Task(s)],
/*220 - EPS_RAW4*/ EEAAO_RAW.[Technical_Problems(s)],
/*221 - EPS_RAW4*/ EEAAO_RAW.[Night_Technical_Problems(s)],
/*222 - EPS_RAW4*/ EEAAO_RAW.[Day_Technical_Problems(s)],
/*223 - EPS_RAW4*/ EEAAO_RAW.[Training(s)],
/*224 - EPS_RAW4*/ EEAAO_RAW.[Night_Training(s)],
/*225 - EPS_RAW4*/ EEAAO_RAW.[Day_Training(s)],
/*226 - EPS_RAW4*/ EEAAO_RAW.[Unscheduled_Picklist(s)],
/*227 - EPS_RAW4*/ EEAAO_RAW.[Night_Unscheduled_Picklist(s)],
/*228 - EPS_RAW4*/ EEAAO_RAW.[Day_Unscheduled_Picklist(s)],
/*229 - EPS_RAW4*/ EEAAO_RAW.[Work_Council(s)],
/*230 - EPS_RAW4*/ EEAAO_RAW.[Night_Work_Council(s)],
/*231 - EPS_RAW4*/ EEAAO_RAW.[Day_Work_Council(s)],
/*232 - Target*/ EEAAO_RAW.[Overall CPH tar],
/*233 - Target*/ EEAAO_RAW.[Phone CPH tar],
/*234 - Target*/ EEAAO_RAW.[Non Phone CPH tar],
/*235 - Target*/ EEAAO_RAW.[Quality - Customer Impact tar],
/*236 - Target*/ EEAAO_RAW.[Quality - Business Impact tar],
/*237 - Target*/ EEAAO_RAW.[Quality - Compliance Impact tar],
/*238 - Target*/ EEAAO_RAW.[Quality - Overall tar],
/*239 - Target*/ EEAAO_RAW.[AHT Phone tar],
/*240 - Target*/ EEAAO_RAW.[AHT Non-phone tar],
/*241 - Target*/ EEAAO_RAW.[AHT Overall tar],
/*242 - Target*/ EEAAO_RAW.[Hold (phone) tar],
/*243 - Target*/ EEAAO_RAW.[AACW (phone) tar],
/*244 - Target*/ EEAAO_RAW.[Avg Talk Time tar],
/*245 - Target*/ EEAAO_RAW.[Phone CSAT tar],
/*246 - Target*/ EEAAO_RAW.[Non phone CSAT tar],
/*247 - Target*/ EEAAO_RAW.[Overall CSAT tar],
/*248 - Target*/ EEAAO_RAW.[PSAT tar],
...
Order by EEAAO_RAW2.[Emp ID], EEAAO_RAW2.[Date] DESC;
--USE wfm_vn_dev
--SET SHOWPLAN_ALL ON
